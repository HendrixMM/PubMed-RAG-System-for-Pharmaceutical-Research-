...
> Tip: This template is designed for clarity and auditability — every answer is traceable to its sources.

---

## ✨ Highlights

- Customizable to your data, domain, and guardrails
- Compliance-first with transparent source traceability
- Scales to thousands of documents and live APIs
- Clear, concise briefings for decision makers
...
📧 [hendrixmoreau123@gmail.com](mailto:hendrixmoreau123@gmail.com) • 💼 [LinkedIn](https://www.linkedin.com/in/your-profile) • 🔗 [Live Demo](#-demo-pharmaceutical-research)
...
- [API Reference](docs/API_REFERENCE.md) — environment variables, endpoints, and payload schemas
- [Examples](docs/EXAMPLES.md) — runnable ingestion, retrieval, MCP, and monitoring snippets
- [Benchmarks](docs/BENCHMARKS.md) — datasets, manifests, and reproducible test harnesses
- [ADR-0001: Use NeMo Retriever](docs/adr/0001-use-nemo-retriever.md) — rationale for the architecture direction

### Documentation Quality

```bash
# Install MkDocs + authoring dependencies
pip install -r requirements-dev.txt

# Validate navigation, links, and strict mode rules
mkdocs build --strict
```
